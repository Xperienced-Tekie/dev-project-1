...
import Input from "./_components/reuseables/Input";
import Avater, { filterUser } from "./_components/reuseables/Avatar";
import useFetch from "./_components/chat/useFetch";
...
function FriendSearcher() {
  ...
  return (
    <div className="bg-fuchsia-100 flex items-center justify-start flex-col">
